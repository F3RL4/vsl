...
Este guia mostra como, no **Windows**, pegar um arquivo `.mp4`, quebrar em HLS (`.m3u8` + `.ts`) com **FFmpeg** e publicar como uma nova VSL no repositório `F3RL4/vsl`, usando:
...
No PowerShell ou Prompt:
    ...
    git clone https://github.com/F3RL4/vsl.git
    cd vsl
...
7. Todas as URLs de exemplo deste README usam:
       ...
       https://F3RL4.github.io/vsl/

   Se você estiver usando **seu próprio repositório**, troque `F3RL4` pelo **seu usuário** em todas as URLs, por exemplo:

   - De:

         https://F3RL4.github.io/vsl/player.html?v=vsl_004

   - Para algo como:

         https://seuusuario.github.io/vsl/player.html?v=vsl_004

> Se você está usando diretamente o repositório original `F3RL4/vsl`, não precisa mudar nada aqui.  
...
3. No final, o script mostra as URLs prontas, por exemplo (para o repositório `F3RL4/vsl`):

   - Playlist HLS:

         https://F3RL4.github.io/vsl/vsl_00X/index.m3u8

   - Player com botão de unmute:

         https://F3RL4.github.io/vsl/player.html?v=vsl_00X

> Se for o **seu repositório**, troque `F3RL4` pelo **seu usuário GitHub** nas URLs.
...
Exemplo de uso com `<iframe>` em qualquer página HTML:
    ...
    <iframe
      src="https://F3RL4.github.io/vsl/player.html?v=vsl_004"
      width="100%"
      height="360"
      frameborder="0"
...
> Se estiver em **outro repositório**, troque `F3RL4` pelo seu usuário GitHub.

### 6.2. Via player próprio (HLS direto)

Playlist HLS pública (exemplo `vsl_004`):

    https://F3RL4.github.io/vsl/vsl_004/index.m3u8
